            ...
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage">
                     ...
                     <span>This is some dummy text ... There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected randomised words which don't look even slightly believable</span>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="clothes_main section ">
          <div class="container">
            <div class="row">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="sport_product">
                     <figure><img src="images/chev10.png" alt="img"/"></figure>
                   <h3><strong class="price_text">50</strong></h3>
                     <h4>Staff</h4>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 ">
                  <div class="sport_product">
                     <figure><img src="images/chev4.png" alt="img"/"></figure>
                    <h3><strong class="price_text">50</strong></h3>
                     <h4>Scroll</h4>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 ">
                  <div class="sport_product">
                     <figure><img src="images/chev6.png" alt="img"/"></figure>
                    <h3><strong class="price_text">50</strong></h3>
                     <h4>Sword</h4>
                  </div>
               </div>
